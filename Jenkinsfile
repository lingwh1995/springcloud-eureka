  ...
  stages {
    ...
    stage('推送部署') {
      steps {
        echo '正在推送文件...'
        echo '${GIT_COMMIT_MSG}'
        sh 'git fetch https://lingwh1995:04cacc5f135e93b1ed679462a55260b7@gitee.com/lingwh1995/springcloud-eureka.git'
        sh 'git push -f https://lingwh1995:04cacc5f135e93b1ed679462a55260b7@gitee.com/lingwh1995/springcloud-eureka.git HEAD:master'
